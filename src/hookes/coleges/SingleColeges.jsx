...
const SingleColeges = ({ data }) => {
    const { _id, image, collegeName, admissionDates, events, researchHistory, sports, rating } = data
        ...
        <div className="card w-full  ">
            ...
            <div className="card-body font-serif">
                ...
                <div className="card-actions ">
                    <Link className="w-full" to={`/mycolege/${_id}`}><button className="btn btn-primary w-full my-4">dtails<FaLongArrowAltRight /></button></Link>
                </div>
            </div>
        </div>
    );
